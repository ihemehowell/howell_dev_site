// Fixed Hero.tsx - Simplified structure
'use client'
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-10">
      ...
      <div className="max-w-6xl px-6 text-center">
        ...
        <p className="mt-6 text-lg md:text-xl text-neutral-400 max-w-3xl mx-auto">
          HowellDev is a product-focused studio creating high-performance websites,
          web apps, and digital experiences for ambitious teams.
        </p>
